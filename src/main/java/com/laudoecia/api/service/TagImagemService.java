...
public class TagImagemService {
	...
	public List<TagImagemResumo> CriarTabela(Long codigo){
		Tagimagem tagimagem = this.BuscarPorId(codigo);
		List<TagImagemResumo> lista = new ArrayList<TagImagemResumo>();
		
		TagImagemResumo gamb = new TagImagemResumo();
		gamb.setTag("(0008,0010)");
		gamb.setIdentificacao("ImageType");
		gamb.setCampo(tagimagem.getImagetype());
		lista.add(gamb);
		
		gamb = new TagImagemResumo();
