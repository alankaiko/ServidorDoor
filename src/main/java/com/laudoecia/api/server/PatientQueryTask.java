...
import com.laudoecia.api.resources.ServerDicom;
...
class PatientQueryTask extends BasicQueryTask {
	...
	public PatientQueryTask(Association as, PresentationContext pc, Attributes rq, Attributes keys, DicomServer qrscp)
	...
	protected boolean findNextPatient() throws IOException {
		...
		this.patRec = patient.getAtributo();
//        if (patRec == null)
