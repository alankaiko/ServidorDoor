...
public class OurAdtA01MessageBuilder {
	 ...
	 * from your application here I will leave that to you to explore on your own
	...
	private void createPidSegment() throws DataTypeException {
		...
		patientName.getFamilyName().getSurname().setValue("Teste");
		patientName.getGivenName().setValue("Juremas");
