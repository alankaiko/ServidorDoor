...
public class PersonName implements Serializable {
	...
	private void createOrUpdateSoundexCodes(FuzzyStr fuzzy, String nullValueStr, String familyName, String givenName,
			String middleName) {
	...
	public static PersonName valueOf(String s, FuzzyStr fuzzyStr, String nullValueStr, PersonName prev) {
		...
		if (prev != null) {
			if (!pn.equals(prev.toPersonName()))
				prev.fromDicom(pn, fuzzyStr, nullValueStr);
			return prev;
		} else
			return new PersonName(pn, fuzzyStr, nullValueStr);
	}
